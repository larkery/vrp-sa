...
public class CL2opt2 extends CLNoptK {

	public CL2opt2(CrossingTracker crossingList, HintonRandom random) {
...
//		final int route1ix = solution.routeContaining(c.e11 == 0 ? c.e12 : c.e11);
//		final int route2ix = solution.routeContaining(c.e21 == 0 ? c.e22 : c.e21);
...
//		
//		IMove result = new M2O2(solution.get(route1ix), solution.get(route2ix), a, b);
//		
//		temp.clear();
//		return result;
	}
	...
	public int size(Solution solution) {
		return crossingList.size() * crossingList.size();
	}
}
